         ...
         try {
            ...
            if (response.success) {
               ...
               response.errors.map((error, i) => {
                  ...
                  switch (error) {
                     case 'Cost invalid':
                        dispatch(setSnackBarStatus({isOpen: true, message: t('COST_INVALID'), success: false}));
                        break;
                     case 'Weight is invalid':
                        dispatch(setSnackBarStatus({isOpen: true, message: t('WEIGHT_INVALID'), success: false}));
                        break;
                     case 'SeatsAmount is invalid':
                        dispatch(setSnackBarStatus({isOpen: true, message: t('SEATS_INVALID'), success: false}));
                        break;
                     case 'Warehouse max allowed weight: 30':
                        dispatch(setSnackBarStatus({isOpen: true, message: t('WEIGHT_MAX'), success: false}));
                        break;
                     case 'SendersPhone invalid format':
                        dispatch(setSnackBarStatus({isOpen: true, message: t('SENDER_NUMBER_INVALID'), success: false}));
                        break;
                     case 'RecipientsPhone invalid format':
                        dispatch(setSnackBarStatus({isOpen: true, message: t('RECIPIENTS_NUMBER_INVALID'), success: false}));
                        break;
                     case 'Recipient counterparty person creation problem.':
                        dispatch(setSnackBarStatus({isOpen: true, message: t('PERSON_PROBLEM'), success: false}));
                        break;
